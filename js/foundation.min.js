        ...
        o = {
            ...
            reflow: function (e, n) {
                ...
                t.each(n, function (n, o) {
                    var a = s._plugins[o],
                        r = t(e).find("[data-" + o + "]").addBack("*");
                    r.each(function () {
                        var e = t(this),
                            n = {};
                        if (e.attr("zf-plugin")) return void console.warn("Tried to initialize " + o + " on an element that already has a Foundation plugin.");
...
function (t) {
    ...
    i.defaults = {
    ...
    }, i.prototype._init = function () {}, i.prototype._events = function () {
        var t = this;
    ...
    }, i.prototype._reflow = function () {}, i.prototype.requiredCheck = function (t) {
        switch (t[0].type) {
            case "text":
        ...
        var i = this,
            n = (e(':radio[name="' + t + '"]').siblings("label"), 0);
        return e(':radio[name="' + t + '"]').each(function () {
            i.requiredCheck(e(this)) || n++, e(this).is(":checked") && (n = 0)
        }), n > 0 ? !1 : !0
    }, i.prototype.matchValidation = function (t, e) {}, i.prototype.resetForm = function (t) {
        var i = this,
            n = "data-invalid";
    ...
    }, i.prototype.destroy = function () {}, t.plugin(i, "Abide"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["foundation"], function () {
        return i
    })
    ...
    i.defaults = {
        ...
        var n = i.parent().siblings(),
            s = this,
            o = this.options.multiExpand ? n.hasClass("is-active") : i.parent().hasClass("is-active");
    ...
    }, i.prototype.destroy = function () {}, t.plugin(i, "Equalizer"), "undefined" != typeof module && "undefined" != typeof module.exports && (module.exports = i), "function" == typeof define && define(["foundation"], function () {
        return i
    })
}(Foundation, jQuery), ! function (t, e) {
    "use strict";
    ...
    }, i.prototype.destroy = function () {}, e.plugin(i, "OffCanvas")
}(jQuery, Foundation), ! function (t, e) {
    "use strict";
    ...
    i.defaults = {
        ...
        var d = this,
            ...
            m = n(i, this.options.end).toFixed(this.options.decimal),
            g = (p - f) * m,
    ...
    i.defaults = {
        ...
        this._removeSticky(!0), this.$element.removeClass(this.options.stickyClass + " is-anchored is-at-top").css({
            ...
            bottom: "",
            "max-width": ""
        }).off("resizeme.zf.trigger"), this.$anchor.off("change.zf.sticky"), t(window).off("scroll.zf.sticky"), this.wasWrapped ? this.$element.unwrap() : this.$container.removeClass(this.options.containerClass).css({
            height: ""
        }), e.unregisterPlugin(this)
    }, e.plugin(i, "Sticky")
}(jQuery, window.Foundation), ! function (t, e) {
